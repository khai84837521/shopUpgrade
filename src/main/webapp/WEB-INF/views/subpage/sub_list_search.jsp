        	...
        	<div class="search_panel_wrapper Search Search_S">
				<div class="innerContent">	
					...
					<div id="subcatedepth1" class="ssSection">
						...
						<div class="ssCont">
							<div class="sBox"><a href="#" class="on">All</a></div>
							<div class="sBox"><a href="${pageContext.request.contextPath}/sub?c=a&l=A">건강기능식품</a></div>
		...
		<form name="frmList" action="">
			...
			<fieldset>
				...
				<div class="align">
					<ul>
						<li>
							<input type="radio" id="sort1" class="radio" name="searchType" value="orderCnt desc,reviewCnt desc"><!-- 주문많은순 리뷰많은순 -->
							<label for="sort1" class="on">판매인기순</label>
						</li>
						<li>
							<input type="radio" id="sort3" class="radio" name="searchType" value="goodsPrice,salesStartYmd desc"><!-- 가격오름차순 판매일 내림차순 -->
				...
				<div class="item-display-wrap">
					<div class="item-display type-cart clear cboth">
						<div class="list innerContent">
							<!-- 상품목록 -->
							<ul>
							<c:forEach var="ListDTO" items="${mainSearch }">
							<li class="line_4">
							...
							<div class="paging">
								<c:if test="${pageDTO.startPage > pageDTO.pageBlock }">
									<a href="${pageContext.request.contextPath}/sub_list_search?pageNum=${pageDTO.startPage-pageDTO.pageBlock}">[이전]</a>
								</c:if>
								<c:forEach var="i" begin="${pageDTO.startPage }" end="${pageDTO.endPage }" step="1">
									<a href="${pageContext.request.contextPath}/sub_list_search?pageNum=${i}">${i} </a>
								</c:forEach>
								<c:if test="${pageDTO.endPage < pageDTO.pageCount }">
									<a href="${pageContext.request.contextPath}/sub_list_search?pageNum=${pageDTO.startPage+pageDTO.pageBlock}">[다음]</a>
								</c:if>
							</div>
								<!-- //페이징 끝-->
						</div><!-- proslide01 -->
