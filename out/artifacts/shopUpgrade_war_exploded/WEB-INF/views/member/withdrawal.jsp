	...
	<div id="login_box">
		<div class="login_con">
			...
			<div class="formbox selected">
				<form name="frm_user" id="frm_user" action="${pageContext.request.contextPath}/passChangePro" method="POST" onsubmit = "return passOk()">
						<div class="tabCont">
									...
									<div class="column">
										<strong class="title">비밀번호 재설정</strong>
											<div class="gridPosition">
												<input type = "hidden" value ="${user.memId}" name = "memId" id = "id">
												<input type = "hidden" value = "0" id = "passExamine">
												<input type="password" placeholder="비밀번호를 재설정해주세요" class="fText typePassword" title="비밀번호" name="memPw" id="pass" tabindex="2" maxlength="20" onkeyup="findPassOk()" >
